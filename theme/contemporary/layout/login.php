    ...
    <body id="<?php p($PAGE->bodyid) ?>" class="<?php p($PAGE->bodyclasses . ' ' . join(' ', $bodyclasses)) ?>">
        ...
        <div id="page">
            <div id="wrapper" class="clearfix">
                <div class="top-bar">
            			<div class="logo_div">
            				<img src="<?php echo $OUTPUT->pix_url('logo', 'theme') ?>" onclick="window.location.href='index.php'" class="logo" />
                    		
            			</div>
            			<div class="headermenu">
                    	<ul style="line-height: 10vh;">
                        <?php
                    /*
                    ...
                    */
                        ?>
                        <li><img src="<?php echo $OUTPUT->pix_url('login', 'theme') ?>" onclick="window.location.href='index.php'" /></li>
                        </ul>
                    </div>
                        ...
                        <!--<div id="region-main-box">
                            <div id="region-post-box">
                                <div id="region-main-wrap">-->
                               		<!--<div class="divWhiteLine" style="height: 90%; position: absolute; top: 5%; left: 50%; border: 1px solid #6f6f6f; width: 0;"></div>!-->
                                		<div id="region-main" style="width:100%; float:none; padding:0px; position: relative;">
                                    		<!--<div class="divWhiteLine" style="height: 90%; position: absolute; top: 5%; left: 50%; border: 1px solid #6f6f6f; width: 0;"></div>!-->
            ...
            <!-- START OF FOOTER -->
                <div id="page-footer" class="clearfix">
                		<?=$PAGE->theme->settings->footertext;?>
