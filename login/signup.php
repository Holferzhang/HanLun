...
if ($mform_signup->is_cancelled()) {
    ...
    //username  email  email2 lastname  lastname
    $user->username = $user->email2 = $user->lastname = $user->lastname = $user->email;
...
echo '
<style>
.top-bar{background: rgb(107,40,104) !important;}
#login_submit{width:120px !important; margin-left:30%;background: rgb(172,72,134) !important;}
.region-content h3{}
.region-content input[type=text],input[type=password]{width:340px !important;height:30px; line-height:30px;}
#fitem_id_email .fitemtitle{float: left;}
</style>
';
